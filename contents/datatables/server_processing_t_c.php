...
if (session_status() == PHP_SESSION_NONE) {
    ...
    if (!isset($_SESSION['teacher']) || $_SESSION['teacher'] == 0) header('Location: ./../../php/home.php');
}
...
if (isset($_SESSION['email'])) {
    ...
    error_log('server_processing_t_c.php - Email not found', 3, './../../../error_log.txt');
    exit();
}
...
echo json_encode(
    SSP::complex($_GET, $sql_details, $table, $primaryKey, $columns, null, "creator='$email'")
);
?>
